(function () {
  ...
  const dict = {
    ...
    ar: {
      title: "سيلفاريوم سوشل",
      subtitle: "منصة احترافية لنشر وإدارة المحتوى على منصات التواصل",
      desc:
        "سيلفاريوم سوشل منصة احترافية تساعد الفرق على نشر المحتوى وجدولته وإدارته عبر منصات التواصل المدعومة.\n\n" +
      ...
      statusBody:
        "خدمات سيلفاريوم سوشل تعمل بشكل طبيعي حاليًا. " +
